...
Have a look at our table documentation for some [insight into how we're using CSS variables]({{< docsref "table" >}}). Our [navbars also use CSS variables]({{< docsref "navbar" >}}) as of v5.2.0. We're also using CSS variables across our grids—primarily for gutters the [new opt-in CSS grid]({{< docsref "css-grid" >}})—with more component usage coming in the future.
