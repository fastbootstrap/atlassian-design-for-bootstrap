...
(function (global, factory) {
  ...
  */
  ...
  const EVENT_CLICK_DATA_API$4 = `click${EVENT_KEY$8}${DATA_API_KEY$4}`;
  ...
  const EVENT_LOAD_DATA_API$2 = `load${EVENT_KEY$4}${DATA_API_KEY$1}`;
  ...
  const EVENT_LOAD_DATA_API$1 = `load${EVENT_KEY$3}`;
  ...
  class Tab extends BaseComponent {
    ...
    _keydown(event) {
      if (!([ARROW_LEFT_KEY$1, ARROW_RIGHT_KEY$1, ARROW_UP_KEY, ARROW_DOWN_KEY, HOME_KEY, END_KEY].includes(event.key))) {
        return
      }
